INSERT INTO customers VALUES (1,'EPAM','ul. Academician Kuprevich, 1, k. 1', 0, 0),
  (2,'ASWardag','ul. Brovki 4B, office 63',0, 0),
  (3,'Mainsoft','ul. Communist, 16',0, 0),
  (4,'Game Factory','ul. Chkalov 56a',0, 0),
  (5,'ArtVebBay','ul. Of Truth, 46-17',0, 0),
  (6,'Redline','Frunze 81, 33a, office 511',0, 0),
  (7,'iTechArt','ul. Tolstoy, 10',0, 0),
  (8,'GoodSoft','Prospect Chernyakhovsky, 44 of.216',0, 0),
  (9,'ConnectOne','Frunze 77/2',0, 0),
  (10,'PCB Vitebsk','ul. Zamkovaya, 4-3, cab. 304',0, 0),
  (11,'LACIT','st. Lazo 149,',0, 0);
