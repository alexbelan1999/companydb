CREATE TABLE companies(id int(10) NOT NULL AUTO_INCREMENT, cname varchar(50) NOT NULL, address varchar(50) NOT NULL,PRIMARY KEY (id))
  
CREATE TABLE managers (id int (10) NOT NULL AUTO_INCREMENT, surname varchar (25) NOT NULL, name varchar (25) NOT NULL, patronymic varchar (25) NULL, PRIMARY KEY (id));
 
CREATE TABLE projects (id int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE users (
  ...
  INSERT INTO companies VALUES (1,'EPAM','ul. Academician Kuprevich, 1, k. 1'),
  (2,'ASWardag','ul. Brovki 4B, office 63'),
  (3,'Mainsoft','ul. Communist, 16'),
  (4,'Game Factory','ul. Chkalov 56a'),
  (5,'ArtVebBay','ul. Of Truth, 46-17'),
  (6,'Redline','Frunze 81, 33a, office 511'),
  (7,'iTechArt','ul. Tolstoy, 10'),
  (8,'GoodSoft','Prospect Chernyakhovsky, 44 of.216'),
  (9,'ConnectOne','Frunze 77/2'),
  (10,'PCB Vitebsk','ul. Zamkovaya, 4-3, cab. 304'),
  (11,'LACIT','st. Lazo 149,');
  ...
  INSERT INTO projects VALUES (1,1,'Test program','2012-12-12','2013-02-01',NULL,1,0),
...
insert into `users`(id,`login`,`password`,`role_id`) VALUES 
  ...
  SELECT customers.name as customer,projects.project_name,projects.start_date,projects.plan_end_date,projects.end_date,managers.surname as manager,projects.success 
  FROM customers 
