...
<body>
    ...
    <section class="users">
        ...
        <c:if test="<%= object != null && object.getRole_id() == 1%>">
		    <a href="/company/EditUserServlet" class="reg btn">Добавить</a>
		</c:if>
        <table class="users__table">
            <tr>
                <th><a href="/company/ListUsersServlet?table=id">id</a></th>
                <th><a href="/company/ListUsersServlet?table=login">login</a></th>
                <th><a href="/company/ListUsersServlet?table=role_id">Роль</a></th>
                <c:if test="<%= object != null && object.getRole_id() == 1%>">
            ...
            <%
             ...
             %>
             		<tr>
		              ...
		              <c:if test="<%= object != null && object.getRole_id() == 1%>">
			    		<td class="edit"><a href="/company/EditUserServlet?id=<%= user.getId() %>"><i class="far fa-edit fa-lg"></i></a></td>
	              		<td class="del"><a href="/company/DeleteUser?id=<%= user.getId() %>"><i class="fas fa-trash-alt fa-lg"></i></a></td>
					  </c:if>
	          		</tr> 
             <%
                 }
