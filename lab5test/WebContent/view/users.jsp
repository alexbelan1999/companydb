...
<body>
    ...
    <section class="users">
        <h3 class="users__header">Teachers</h3>
        <c:if test="<%= object != null && object.getRole_id() == 1%>">
		    <a href="/lab5test/EditUserServlet" class="reg btn">Добавить</a>
		</c:if>
        <table class="users__table">
            <tr>
                <th><a href="/lab5test/ListUsersServlet?table=id">id</a></th>
                <th><a href="/lab5test/ListUsersServlet?table=login">login</a></th>
                <th><a href="/lab5test/ListUsersServlet?table=role_id">Роль</a></th>
                <c:if test="<%= object != null && object.getRole_id() == 1%>">
            ...
            <%
             ...
             %>
             		<tr>
		              ...
		              <c:if test="<%= object != null && object.getRole_id() == 1%>">
			    		<td class="edit"><a href="/lab5test/EditUserServlet?id=<%= user.getId() %>"><i class="far fa-edit fa-lg"></i></a></td>
	              		<td class="del"><a href="/lab5test/DeleteUser?id=<%= user.getId() %>"><i class="fas fa-trash-alt fa-lg"></i></a></td>
					  </c:if>
	          		</tr> 
             <%
                 }
